...
impl LoginAttemptRepository {
    ...
    pub fn create(user_id: Option<Uuid>, success: bool, user_agent: Option<String>) -> Result<LoginAttempt, RepositoryError> {
    ...
    pub fn count_failed_attempts(user_id: Uuid, minutes: i64) -> Result<i64, RepositoryError> {
        ...
        login_attempts::table
            ...
            .filter(login_attempts::attempted_at.gt(chrono::Utc::now() - chrono::Duration::minutes(minutes)))
            .count()
